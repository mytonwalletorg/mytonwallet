//
//  TitleSubtitleSelectableCell.swift
//  UIComponents
//
...
@MainActor fileprivate var checkmarkImage = UIImage(systemName: "checkmark")

public class TitleSubtitleSelectableCell: UITableViewCell, WThemedView {
    ...
    private var subtitleColor = WTheme.primaryLabel
