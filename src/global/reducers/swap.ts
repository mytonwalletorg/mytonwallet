...
import { DEFAULT_SLIPPAGE_VALUE, TON_TOKEN_SLUG } from '../../config';
import { fromDecimal, toDecimal } from '../../util/decimals';
import { TOKEN_TRANSFER_TON_AMOUNT } from '../../api/blockchains/ton/constants';
...
export function updateCurrentSwapFee(
  ...
  const compositeFee = fromDecimal(estimate.networkFee) + TOKEN_TRANSFER_TON_AMOUNT;
